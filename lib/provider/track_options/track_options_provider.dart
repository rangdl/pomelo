...
import 'package:pomelo/components/dialogs/playlist_add_track_dialog.dart';
import 'package:pomelo/components/dialogs/prompt_dialog.dart';
import 'package:pomelo/components/dialogs/track_details_dialog.dart';
...
// import 'package:pomelo/provider/metadata_plugin/library/playlists.dart';
// import 'package:pomelo/provider/metadata_plugin/library/tracks.dart';
        ...
        if (context.mounted) {
          showToast(
            ...
            builder: (context, overlay) {
              return SurfaceCard(
                child: Text(
                  context.l10n.removed_track_from_queue(track.name),
                  textAlign: TextAlign.center,
                ),
              );
            },
