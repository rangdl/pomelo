...
typedef MetadataFile = ({Metadata? metadata, File file, String? art});
      ...
      try {
        ...
        for (final location in [
          ...
          if (await Directory(location).exists()) {
            try {
              final dirEntities = await Directory(
                location,
                ...
                final imageFile = File(
                  join(
                    ...
                    ServiceUtils.sanitizeFilename(
                        ...
                        imgMimeToExt[metadata.picture?.mimeType ??
                            "image/jpeg"]!,
                  ),
                );
          ...
          final tracksFromMetadata = filesWithMetadata
              .map(
                (fileWithMetadata) =>
                    SpotubeTrackObject.localTrackFromFile(
