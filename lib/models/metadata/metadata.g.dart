...
_$SpotubeSimpleArtistObjectImpl _$$SpotubeSimpleArtistObjectImplFromJson(
  ...
  images: (json['images'] as List<dynamic>?)
      ?.map(
        (e) => SpotubeImageObject.fromJson(Map<String, dynamic>.from(e as Map)),
      )
      .toList(),
);
...
_$PomeloTrackObjectMetaImpl _$$PomeloTrackObjectMetaImplFromJson(Map json) =>
...
Map<String, dynamic> _$$PomeloTrackObjectMetaImplToJson(
  _$PomeloTrackObjectMetaImpl instance,
) => <String, dynamic>{
  'name': instance.name,
