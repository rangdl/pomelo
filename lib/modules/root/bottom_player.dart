...
import 'package:pomelo/modules/player/player_overlay.dart';
import 'package:pomelo/modules/player/player_track_details.dart';
  ...
  Widget build(BuildContext context, ref) {
    ...
    return SurfaceCard(
      ...
      child: Row(
        ...
        children: [
          Expanded(child: PlayerTrackDetails(track: playlist.activeTrack)),
          // controls
          const Flexible(
            flex: 3,
            child: Padding(
