...
// import 'package:pomelo/modules/metadata_plugins/plugin_update_available_dialog.dart';
// import 'package:pomelo/provider/metadata_plugin/metadata_plugin_provider.dart';
// import 'package:pomelo/provider/metadata_plugin/updater/update_checker.dart';
// import 'package:pomelo/provider/server/routes/connect.dart';
// import 'package:pomelo/services/audio_player/audio_player.dart';
// import 'package:pomelo/services/connectivity_adapter.dart';
...
//       final pluginUpdate = await ref.read(
//         metadataPluginUpdateCheckerProvider.future,
//       );
...
//               filled: true,
//               child: Basic(
//                 leading: const Icon(SpotubeIcons.error, color: Colors.black),
//                 title: Text(
