...
import 'package:pomelo/modules/player/player_queue.dart';
// import 'package:pomelo/modules/player/sibling_tracks_sheet.dart';
import 'package:pomelo/components/adaptive/adaptive_pop_sheet_list.dart';
// import 'package:pomelo/components/heart_button/heart_button.dart';
...
import 'package:pomelo/provider/sleep_timer_provider.dart';
...
class PlayerActions extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    }, [playlist.activeTrack, downloader]);
    ...
    return Row(
      ...
      children: [
        ...
        if (!kIsWeb && !isLocalTrack)
          if (isInQueue)
            const SizedBox(
              height: 20,
              width: 20,
              child: CircularProgressIndicator(size: 2),
            )
          else
            Tooltip(
              tooltip: TooltipContainer(
        ...
        AdaptivePopSheetList<Duration>(
          ...
          headings: [Text(context.l10n.sleep_timer)],
          icon: Icon(
            SpotubeIcons.timer,
