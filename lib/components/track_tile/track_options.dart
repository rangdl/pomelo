...
import 'package:pomelo/provider/track_options/track_options_provider.dart';
          ...
          ButtonTile(
            ...
            title: Column(
              ...
              children: [
                ...
                Text(track.album.name, style: context.theme.typography.xSmall),
              ],
            ),
          ),
        if (!isInQueue) ...[
            ...
            leading: isInDownloadQueue
                ? StreamBuilder(
                    ...
                    builder: (context, snapshot) {
                      final progress =
                          downloadTask?.totalSizeBytes == null ||
