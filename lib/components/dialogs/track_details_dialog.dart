...
import 'package:pomelo/components/links/hyper_link.dart';
    ...
    return AlertDialog(
      ...
      title: Row(
        ...
        children: [
          ...
          Text(context.l10n.details, style: theme.typography.h4),
        ],
      ),
      content: SizedBox(
          ...
          rows: [
            for (final entry in detailsMap.entries)
              TableRow(
                cells: [
                  TableCell(
                    child: Text(entry.key, style: theme.typography.bold),
                  ),
