...
// import 'package:pomelo/modules/artist/artist_album_list.dart';

// import 'package:pomelo/pages/artist/section/footer.dart';
// import 'package:pomelo/pages/artist/section/header.dart';
// import 'package:pomelo/pages/artist/section/related_artists.dart';
// import 'package:pomelo/pages/artist/section/top_tracks.dart';
// import 'package:pomelo/provider/metadata_plugin/artist/albums.dart';
// import 'package:pomelo/provider/metadata_plugin/artist/artist.dart';
import 'package:auto_route/auto_route.dart';
// import 'package:pomelo/provider/metadata_plugin/artist/related.dart';
// import 'package:pomelo/provider/metadata_plugin/artist/top_tracks.dart';
// import 'package:pomelo/provider/metadata_plugin/artist/wikipedia.dart';
// import 'package:pomelo/provider/metadata_plugin/library/artists.dart';
...
class ArtistPage extends HookConsumerWidget {
  ...
  const ArtistPage(@PathParam("id") this.artistId, {super.key});
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        child: material.RefreshIndicator.adaptive(
          ...
          child: Builder(
            builder: (context) {
              return Center(child: Text(artistId));
            },
          ),
        ),
      ),
